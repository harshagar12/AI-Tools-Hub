...
start "Backend Server" cmd /c ".\venv\Scripts\activate && cd /d venv && uvicorn api_server:app --host 0.0.0.0 --port 8000 --reload"
...
echo Backend: http://localhost:8000 (check Backend Server window)
